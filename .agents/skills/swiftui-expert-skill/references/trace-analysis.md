> **Not vendored in this repo.** The `scripts/` directory (Python xctrace helpers) was deliberately omitted under the text-only vendoring rule; see `.agents/skills/SKILLS-LOCK.md`. The commands below need the upstream skill checkout.
